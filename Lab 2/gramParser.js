...
var ruleNames =  [ "start", "program", "stmts", "stmt", "loop", "cond", 
                   ...
                   "exprlist", "builtinFuncCall", "cast", "lambda" ];
...
gramParser.RULE_cast = 25;
gramParser.RULE_lambda = 26;
...
gramParser.prototype.cast = function() {
    ...
    this.enterRule(localctx, 50, gramParser.RULE_cast);
    try {
        this.state = 250;
        this._errHandler.sync(this);
...
gramParser.prototype.lambda = function() {
    ...
    this.enterRule(localctx, 52, gramParser.RULE_lambda);
    try {
        this.enterOuterAlt(localctx, 1);
