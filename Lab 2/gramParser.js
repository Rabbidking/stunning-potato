...
var ruleNames =  [ "start", "program", "varDeclList", "varDecl", "varDeclPrime", 
                   "stmts", "stmt", "loop", "cond", "braceblock", "returnStmt", 
                   "expr", "orexp", "andexp", "notexp", "rel", "sum", "term", 
                   "neg", "factor", "assign", "funcCall", "userFuncCall", 
                   "optionalExprlist", "exprlist", "builtinFuncCall", "cast", 
                   "lambda" ];
...
gramParser.RULE_varDeclList = 2;
gramParser.RULE_varDecl = 3;
gramParser.RULE_varDeclPrime = 4;
gramParser.RULE_stmts = 5;
gramParser.RULE_stmt = 6;
gramParser.RULE_loop = 7;
gramParser.RULE_cond = 8;
gramParser.RULE_braceblock = 9;
gramParser.RULE_returnStmt = 10;
...
gramParser.RULE_assign = 20;
gramParser.RULE_funcCall = 21;
gramParser.RULE_userFuncCall = 22;
gramParser.RULE_optionalExprlist = 23;
gramParser.RULE_exprlist = 24;
gramParser.RULE_builtinFuncCall = 25;
gramParser.RULE_cast = 26;
gramParser.RULE_lambda = 27;
...
gramParser.prototype.varDeclList = function() {
    ...
    this.enterRule(localctx, 4, gramParser.RULE_varDeclList);
    try {
        this.state = 67;
...
VarDeclContext.prototype.varDeclPrime = function() {
    return this.getTypedRuleContext(VarDeclPrimeContext,0);
};
...
gramParser.prototype.varDecl = function() {
    ...
    this.enterRule(localctx, 6, gramParser.RULE_varDecl);
    try {
        this.state = 74;
        this._errHandler.sync(this);
...
function VarDeclPrimeContext(parser, parent, invokingState) {
	if(parent===undefined) {
	    parent = null;
	}
	if(invokingState===undefined || invokingState===null) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = gramParser.RULE_varDeclPrime;
    return this;
}

VarDeclPrimeContext.prototype = Object.create(antlr4.ParserRuleContext.prototype);
VarDeclPrimeContext.prototype.constructor = VarDeclPrimeContext;

VarDeclPrimeContext.prototype.TYPE = function() {
    return this.getToken(gramParser.TYPE, 0);
};

VarDeclPrimeContext.prototype.ID = function() {
    return this.getToken(gramParser.ID, 0);
};

VarDeclPrimeContext.prototype.CMA = function() {
    return this.getToken(gramParser.CMA, 0);
};

VarDeclPrimeContext.prototype.enterRule = function(listener) {
    if(listener instanceof gramListener ) {
        listener.enterVarDeclPrime(this);
	}
};

VarDeclPrimeContext.prototype.exitRule = function(listener) {
    if(listener instanceof gramListener ) {
        listener.exitVarDeclPrime(this);
	}
};
...
gramParser.VarDeclPrimeContext = VarDeclPrimeContext;

gramParser.prototype.varDeclPrime = function() {

    var localctx = new VarDeclPrimeContext(this, this._ctx, this.state);
    this.enterRule(localctx, 8, gramParser.RULE_varDeclPrime);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 76;
        this.match(gramParser.TYPE);
...
gramParser.prototype.stmts = function() {
    ...
    this.enterRule(localctx, 10, gramParser.RULE_stmts);
    try {
        this.state = 84;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.stmt = function() {
    ...
    this.enterRule(localctx, 12, gramParser.RULE_stmt);
    try {
        this.state = 94;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.returnStmt = function() {
    ...
    this.enterRule(localctx, 20, gramParser.RULE_returnStmt);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 122;
...
gramParser.prototype.assign = function() {
    ...
    this.enterRule(localctx, 40, gramParser.RULE_assign);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 201;
        this.match(gramParser.ID);
...
gramParser.prototype.funcCall = function() {
    ...
    this.enterRule(localctx, 42, gramParser.RULE_funcCall);
    try {
        this.state = 207;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.userFuncCall = function() {
    ...
    this.enterRule(localctx, 44, gramParser.RULE_userFuncCall);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 209;
        this.match(gramParser.ID);
...
gramParser.prototype.optionalExprlist = function() {
    ...
    this.enterRule(localctx, 46, gramParser.RULE_optionalExprlist);
    try {
        this.state = 216;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.exprlist = function(_p) {
    ...
    var _prevctx = localctx;
    var _startState = 48;
    this.enterRecursionRule(localctx, 48, gramParser.RULE_exprlist, _p);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 219;
        this.expr();
...
gramParser.prototype.builtinFuncCall = function() {
    ...
    this.enterRule(localctx, 50, gramParser.RULE_builtinFuncCall);
    try {
        this.state = 259;
        this._errHandler.sync(this);
        switch(this._input.LA(1)) {
...
gramParser.prototype.cast = function() {
    ...
    this.enterRule(localctx, 52, gramParser.RULE_cast);
    try {
        this.state = 266;
        this._errHandler.sync(this);
...
gramParser.prototype.lambda = function() {
    ...
    this.enterRule(localctx, 54, gramParser.RULE_lambda);
    try {
        this.enterOuterAlt(localctx, 1);
